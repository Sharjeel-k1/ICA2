(ns closure-projects.ICA2.clojure_airline-broker
...
(defn run
  ...
  (let [data_file_name (str "src/clojure_airline/data/broker_team_" team_number ".csv")]
    (if (.exists (io/as-file data_file_name))
      ...
      (println "Data file not found. Update team number.")
      )
    )
  )
